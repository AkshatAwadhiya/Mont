    ...
    <main className="relative py-16 bg-gray-900 overflow-hidden">
      ...
      <section className="relative px-4 sm:px-6 lg:px-8">
        <section className="text-lg max-w-prose mx-auto">
          ...
          <p className="mt-8 text-lg text-gray-500">This Privacy Policy ("Policy") outlines how Mont ("Mont," "we," "our," or "us") collects, uses, and protects your personal information when you use our Instagram growth services. By using our services, you ("you," "your," or "user") consent to the practices described in this Policy.</p>
          ...
          <p className="text-lg text-gray-500">If you have any questions or concerns regarding this Privacy Policy or our services, please contact us at support@mont.com.</p>
          <p className="text-lg text-gray-500">By using Mont's services, you acknowledge that you have read, understood, and agree to this Privacy Policy.</p>
        </section>
      </section>
    </main>
  );
